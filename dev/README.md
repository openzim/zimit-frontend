...
- To create offliners:
  ...
  This pulls the latest offliner definitions from the [online Zimfarm API](https://farm.openzim.org/)
  and registers them with the dev Zimfarm API. Set `ZIMIT_DEFINITION_VERSION` defined in `dev/docker-compose.yml` to the specific version of the zimit scraper you want.
