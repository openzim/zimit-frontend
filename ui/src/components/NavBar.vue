    ...
    <header>
        <nav class="navbar navbar-expand-md navbar-dark">
            <a class="navbar-brand branding">
                <div class="icon"><img alt="Kiwix logo" src="../assets/Kiwix_logo_v3.svg">
                <Loading/>
                </div>
                <label>Zimit</label>
            </a>
            ...
            <b-navbar-toggle target="nav-collapse"></b-navbar-toggle>
             <b-collapse id="nav-collapse" is-nav>
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <router-link class="nav-link" :to="{ name: 'home' }">New Request</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link class="nav-link" :to="{ name: 'home' }">All Requests</router-link>
                    </li>
                    <li>
